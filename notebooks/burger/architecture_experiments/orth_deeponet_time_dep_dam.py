...
# Dataset paths
dataset_path = Path(config.get('dataset_path', "/Users/haydenoutlaw/Documents/Research/opnet/PDEBench/data/2D_rdb_NA_NA/2D_rdb_NA_NA.h5"))
...
t_grid, x_grid, y_grid, u, s = read_pdebench_h5(dataset_path, max_samples=None, channel=0)
