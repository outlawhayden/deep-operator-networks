...
parser.add_argument("--qr_path",    type=str, default="../orth_td_qr_factors.npz")
parser.add_argument("--meta_path",  type=str, default="../orth_td_meta.npz")
...
ani = animation.FuncAnimation(
    fig, update, frames=len(t_grid), interval=1000 // args.fps, blit=True
)
