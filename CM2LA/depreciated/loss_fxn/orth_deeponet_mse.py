...
plt.title("Trunk Model Training History, MSE, 2-Step")
plt.yscale('log')
plt.ylabel("MSE")
plt.xlabel("step")
...
plt.title("Branch Model Training History, MSE, 2-Step")
plt.yscale('log')
plt.ylabel("MSE")
plt.xlabel("step")
...
print("\n==============================")
print(f"Average Test Absolute L2 (Q_tt @ b(u)): {float(final_test_l2):.6e}")
print("==============================\n")
...
plt.xlabel("t")
plt.ylabel("Absolute L2 error over x")
plt.title("Test Mean Absolute L2 error vs time")
