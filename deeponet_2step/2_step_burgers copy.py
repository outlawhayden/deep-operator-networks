...
# class DeepONet_Step1(eqx.Module):
#     trunk: MLP

#     def __init__(self, A, trunk_arch, key, num_branches, activation=jax.nn.relu, initializer = he_normal()): 
...
#         return jnp.inner(A, trunk_out)

# # DeepONet Class Definition
# class DeepONet_Step2(eqx.Module):
#     branch: MLP
#     trunk: MLP
